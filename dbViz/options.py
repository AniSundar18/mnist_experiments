...
def options():
    ...
    parser.add_argument('--baseset', default='CIFAR10', type=str,
                            ...
                            'CIFAR100_label_noise', 'CIFAR_load', 'MNIST'])
    parser.add_argument('--plane_datasets', nargs="+")
    parser.add_argument('--load_net', type=str, default=None)
    parser.add_argument('--load_ind_net', type=str, default=None)
    parser.add_argument('--load_dist_net', type=str, default=None)
